...
namespace NCompileTimeJsonParser {
    ...
    //
    // Inheriting publicly from `TDataholderMixin` allows classes such as `TJsonValue` to provide the
    ...
    public:
        constexpr TDataHolderMixin(std::string_view data, const TLinePositionCounter& lpCounter) noexcept
